...
class test2(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "test2"  # TODO: make this more human readable by adding spaces
...
class test2Widget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/test2.ui'))
...
class test2Logic(ScriptedLoadableModuleLogic):
...
class test2Test(ScriptedLoadableModuleTest):
  """
